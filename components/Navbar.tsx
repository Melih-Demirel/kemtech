...
export default function NavBar() {
  ...
  return (
    <nav ref={navRef} className="bg-gray-300 p-4 fixed w-full top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="lg:hidden">
          <button onClick={() => setIsOpen(v => !v)} className={hamburgerStyle} aria-label="Open menu">
        ...
        {/* DESKTOP LINKS (section scroll on the home page only) */}
